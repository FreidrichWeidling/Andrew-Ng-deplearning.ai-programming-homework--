...
def initialize_parameters():
    ...
    W1 = tf.compat.v1.get_variable("W1", [25, 12288], initializer=tf.initializers.GlorotUniform(seed=1)) #tf.contrib.layers.xavier_initializer(seed=1)
...
my_image = "C:\\Users\\dell\\PycharmProjects\\Week3\\Wu_enda\\Course_2\\Week3\\images\\thumbs_up.jpg"
## END CODE HERE ##
...
img=np.array(img)
my_image = np.array(Image.fromarray(img).resize((64,64))).reshape((1, 64*64*3)).T
